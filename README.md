...
| [Real_Exam2_var2](Real_Exam2_var2) | Экзаменационный вариант 2: генерация файла "input.txt", работа с матрицами(перемножение, сложение), нахождение минимального элемента в матрице1, пересчет нечетных элементов матрице 1, инициализация таймера работы программмы |   
