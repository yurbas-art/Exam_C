 ...
 * Prototype 4
 * ------------
 * Генерирует две матрицы заданного размера, сохраняет их в input.txt
 * и затем читает обратно. Далее выполняет перемножение и сложение
 * матриц, ищет минимальный элемент и количество нечётных чисел в первой
 * матрице, а также проверяет наличие одинаковых чисел в строках/столбцах.
 * Результаты выводятся в output.txt и на экран вместе со временем работы.
 */
...
// перемножение двух матриц n x m
