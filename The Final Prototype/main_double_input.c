...
/*
 * Программа с вводом размера матрицы
 * и вычислениями в формате double.
 */

// программа с вводом размера матрицы; реализованы сложение,
...
// точка входа: размеры матрицы вводятся пользователем
int main() {
